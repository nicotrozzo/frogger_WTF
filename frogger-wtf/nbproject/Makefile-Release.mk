...
include frogger-wtf-Makefile.mk
...
${OBJECTDIR}/_ext/2dfe622a/action_routines.o: /home/nico/Desktop/NetBeansProjects/frogger_WTFGIT/frogger-wtf/action_routines.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2dfe622a/action_routines.o /home/nico/Desktop/NetBeansProjects/frogger_WTFGIT/frogger-wtf/action_routines.c

${OBJECTDIR}/eventQueue.o: eventQueue.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventQueue.o eventQueue.c
